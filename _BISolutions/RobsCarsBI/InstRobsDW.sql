/*                                                                        */
/*              InstPubs.SQL - Creates the robsdw database                  */ 
/*                                                                        */
/*
...
if exists (select * from sysdatabases where name='robsdw')
begin
  raiserror('Dropping existing robsdw database ....',0,1)
  DROP database robsdw
end
GO
...
raiserror('Creating robsdw database....',0,1)
go
/*
   Use default size with autogrow
*/

CREATE DATABASE robsdw
GO
...
if db_name() <> 'robsdw'
   raiserror('Error in InstPubs.SQL, ''USE robsdw'' failed!  Killing the SPID now.'
            ,22,127) with log

GO

--Removed in 2012
-- execute sp_dboption 'robsdw' ,'trunc. log on chkpt.' ,'true'
GO
...
'This is sample text data for New Moon Books, publisher 0736 in the robsdw database. New Moon Books is located in Boston, Massachusetts.
...
'This is sample text data for Binnet & Hardley, publisher 0877 in the robsdw database. Binnet & Hardley is located in Washington, D.C.
...
'This is sample text data for Algodata Infosystems, publisher 1389 in the robsdw database. Algodata Infosystems is located in Berkeley, California.
...
'This is sample text data for Five Lakes Publishing, publisher 1622 in the robsdw database. Five Lakes Publishing is located in Chicago, Illinois.
...
'This is sample text data for Ramona Publishers, publisher 1756 in the robsdw database. Ramona Publishers is located in Dallas, Texas.')
...
'This is sample text data for GGG&G, publisher 9901 in the robsdw database. GGG&G is located in München, Germany.')
...
'This is sample text data for Scootney Books, publisher 9952 in the robsdw database. Scootney Books is located in New York City, New York.')
...
'This is sample text data for Lucerne Publishing, publisher 9999 in the robsdw database. Lucerne publishing is located in Paris, France.
